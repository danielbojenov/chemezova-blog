{{--
    Fork of vendor/filament/forms/resources/views/components/builder.blade.php (filament/filament v5.6.8),
    rendering the extra `addFirst` action of App\Filament\Support\ContentBuilder above the item list.
    The only changes are the two `$addFirstAction` sections below; re-diff against the vendor view on upgrade.
--}}
@php
    ...
    $addFirstAction = $getAction($getAddFirstActionName());
...
<x-dynamic-component :component="$fieldWrapperView" :field="$field">
    ...
    >
        ...
        @if ($isAddable && $addFirstAction->isVisible())
            <x-filament-forms::builder.block-picker
                :action="$addFirstAction"
